...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", default='/sdb/nlp21/Project/physical/depression-main/data/encoded_GCN_partial_5cdata.csv', help="Path of Graph")
    parser.add_argument("--num_epochs", type=int, default=300, help="No of epochs")
    parser.add_argument("--lr", type=float, default=0.005, help="learning rate")
    parser.add_argument("--dropout", type=float, default=0, help="dropout rate")
    parser.add_argument("--model_no", type=int, default=3, help="Model ID")
    args = parser.parse_args()
    # save_as_pickle("args.pkl", args)
    
    f, X, A_hat, selected, labels_selected, labels_not_selected, test_idxs = load_datasets(args, extra_name='5c')
